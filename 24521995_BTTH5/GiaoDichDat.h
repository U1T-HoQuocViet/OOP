...
class GiaoDichDat : public GiaoDichBDS
{
    ...
    public:
        ...
        GiaoDichDat(const GiaoDichDat &gdv);
        GiaoDichDat(const GiaoDichBDS &gd, string loai_dat);
        ~GiaoDichDat();
        ...
        friend istream& operator>>(istream&, GiaoDichDat&);
        friend ostream& operator<<(ostream&, const GiaoDichDat&);
};
...
GiaoDichDat::GiaoDichDat(const GiaoDichDat &gdv)
    : GiaoDichBDS(gdv), loai_dat(gdv.loai_dat) {}

GiaoDichDat::GiaoDichDat(const GiaoDichBDS &gd, string loai_dat)
    : GiaoDichBDS(gd), loai_dat(loai_dat) {}
...
istream& operator>>(istream &is, GiaoDichDat &gdd)
{
    gdd.Nhap();
    return is;
}

ostream& operator<<(ostream &os, const GiaoDichDat &gdd)
{
    gdd.Xuat();
    return os;
}