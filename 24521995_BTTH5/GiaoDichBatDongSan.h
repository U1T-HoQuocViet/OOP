...
class GiaoDichBDS
{
    ...
    public:
        ...
        GiaoDichBDS(const GiaoDichBDS &gd);
...
GiaoDichBDS::GiaoDichBDS(const GiaoDichBDS &gd)
    : ma_giao_dich(gd.ma_giao_dich), ngay_giao_dich(gd.ngay_giao_dich), don_gia(gd.don_gia), dien_tich(gd.dien_tich) {}
...
void GiaoDichBDS::SetMaGiaoDich(string ma_giao_dich) { this->ma_giao_dich = ma_giao_dich; }
